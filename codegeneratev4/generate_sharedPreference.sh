...
function generateBooleanPre()
{
	echo -e "public static final String Preference_$1 = \"$1\";" >> $fileName
	echo -e "public boolean Get$1() {" >> $fileName
	echo -e "return m_preferences.getBoolean(Preference_$1, false);\n}" >> $fileName
	echo -e "public void Set$1(boolean str$1) {" >> $fileName
	echo -e "m_preferences.edit()" >> $fileName
	echo -e ".putBoolean(Preference_$1, str$1).commit();\n}" >> $fileName
}
function generateIntPre()
{
	echo -e "public static final String Preference_$1 = \"$1\";" >> $fileName
	echo -e "public int Get$1() {" >> $fileName
	echo -e "return m_preferences.getInt(Preference_$1, 0);\n}" >> $fileName
	echo -e "public void Set$1(int $1) {" >> $fileName
	echo -e "m_preferences.edit()" >> $fileName
	echo -e ".putInt(Preference_$1, $1).commit();\n}" >> $fileName
}
function generateSharedPre()
{
	echo -e "public static final String Preference_$1 = \"$1\";" >> $fileName
	echo -e "public String Get$1() {" >> $fileName
	echo -e "return m_preferences.getString(Preference_$1, \"\");\n}" >> $fileName
	echo -e "public void Set$1(String str$1) {" >> $fileName
	echo -e "m_preferences.edit()" >> $fileName
	echo -e ".putString(Preference_$1, str$1).commit();\n}" >> $fileName
}
function generate2
{
	while read line
...
fileName="./OLCROutput"
#generateSharedPre $1
#generateBooleanPre $1

for i in $@
do
   echo $i
   #generateBooleanPre $i
   generateIntPre $i
   #generateSharedPre $i
done
