...
{
	log $1
	ip=114.67.87.215:8001
	curl -H "Content-Type: application/json" -X POST  --data $1  http://$ip/remoteMcuController/getLessonStatus -s -o test1
	cat test1
#{"calss":"com.pm360.cepm360.services.common.FlowApproveService","method":"getCountersignList","p0":"58"}
}
function getLesson()
{
	request "{"lessonId":"595278608772104192"}"	
}
function addTask()
{
